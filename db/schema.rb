...
ActiveRecord::Schema.define(version: 20140320235423) do
  ...
  add_index "equipos", ["institucion_id"], name: "index_equipos_on_institucion_id", using: :btree
  ...
  add_index "users", ["institucion_id"], name: "index_users_on_institucion_id", using: :btree
